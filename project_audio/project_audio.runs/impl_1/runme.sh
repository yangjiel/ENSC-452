...
HD_PWD='C:/Users/yangjiel/Desktop/VGA_mem_mapped-master/project_audio/project_audio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_testbench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_testbench.tcl -notrace
