...
HD_PWD='C:/Users/yangjiel/Desktop/VGA_mem_mapped-master/project_audio/project_audio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_testbench.tcl
