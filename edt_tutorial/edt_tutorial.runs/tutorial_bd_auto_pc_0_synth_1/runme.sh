...
HD_PWD='C:/Users/yangjiel/edt_tutorial/edt_tutorial.runs/tutorial_bd_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial_bd_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tutorial_bd_auto_pc_0.tcl
