...
HD_PWD='U:/edt_tutorial/edt_tutorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tutorial_bd_wrapper.tcl -notrace
