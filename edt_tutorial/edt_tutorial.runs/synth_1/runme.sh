...
HD_PWD='C:/Users/yangjiel/edt_tutorial/edt_tutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tutorial_bd_wrapper.tcl
