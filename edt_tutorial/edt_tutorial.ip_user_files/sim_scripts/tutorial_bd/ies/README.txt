...
#
# Generated by export_simulation on Fri Jan 12 17:45:52 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './tutorial_bd.sh' script.

./tutorial_bd.sh -reset_run
...
./tutorial_bd.sh -noclean_files

For more information on the script, please type './tutorial_bd.sh -help'.
