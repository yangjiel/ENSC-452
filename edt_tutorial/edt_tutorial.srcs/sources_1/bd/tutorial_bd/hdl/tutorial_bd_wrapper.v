...
//Command     : generate_target tutorial_bd_wrapper.bd
//Design      : tutorial_bd_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module tutorial_bd_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  tutorial_bd tutorial_bd_i
       (.DDR_addr(DDR_addr),
        ...
        .btns_5bits_tri_i(btns_5bits_tri_i_0),
        .btns_5bits_tri_o(btns_5bits_tri_o_0),
        .btns_5bits_tri_t(btns_5bits_tri_t_0));
endmodule
