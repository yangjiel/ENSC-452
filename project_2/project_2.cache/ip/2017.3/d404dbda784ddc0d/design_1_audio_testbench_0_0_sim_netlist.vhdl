...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_audio_testbench is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \index[0]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \index[1]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \index[2]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \index[3]_i_1\ : label is "soft_lutpair27";
begin
...
i_audio: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_audio_top
     port map (
      ...
      hphone_valid_reg => i_audio_n_4,
      in0 => sample_clk_48k,
      line_in_r(23 downto 0) => line_in_r(23 downto 0),
      \slow5hz_reg[24]\ => slow5hz_reg(24)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^ld\ : STD_LOGIC_VECTOR ( 6 downto 3 );
begin
  AC_ADR0 <= \<const1>\;
  AC_ADR1 <= \<const1>\;
  LD(6 downto 3) <= \^ld\(6 downto 3);
  LD(2) <= \<const1>\;
  LD(1) <= \<const1>\;
  LD(0) <= \<const1>\;
  LD(7) <= 'Z';
