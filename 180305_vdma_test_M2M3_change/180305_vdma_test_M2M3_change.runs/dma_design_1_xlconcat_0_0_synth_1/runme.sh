...
HD_PWD='C:/Users/jfa49/vdma_test/vdma_test.runs/dma_design_1_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_design_1_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_design_1_xlconcat_0_0.tcl
