...
HD_PWD='C:/Users/yangjiel/Desktop/180305_vdma_test_M2M3_change/180305_vdma_test_M2M3_change.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_design_1_wrapper.tcl
