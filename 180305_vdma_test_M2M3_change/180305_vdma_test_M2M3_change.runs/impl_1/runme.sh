...
HD_PWD='C:/Users/yangjiel/Desktop/180305_vdma_test_M2M3_change/180305_vdma_test_M2M3_change.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_design_1_wrapper.tcl -notrace
