...
HD_PWD='U:/180306_move_everything_from_pit9/180305_vdma_test_M2M3_change/180305_vdma_test_M2M3_change.runs/dma_design_1_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_design_1_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_design_1_xbar_0.tcl
