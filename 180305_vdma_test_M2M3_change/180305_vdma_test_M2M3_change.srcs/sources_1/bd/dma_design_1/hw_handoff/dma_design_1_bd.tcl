...
################################################################
# This is a generated script based on design: dma_design_1
#
...
# source dma_design_1_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: audio_testbench_0, and set properties
  set audio_testbench_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:audio_testbench:1.0 audio_testbench_0 ]
  ...
  connect_bd_net -net AC_GPIO1_0_1 [get_bd_ports AC_GPIO1_0] [get_bd_pins audio_testbench_0/AC_GPIO1]
  connect_bd_net -net AC_GPIO2_0_1 [get_bd_ports AC_GPIO2_0] [get_bd_pins audio_testbench_0/AC_GPIO2]
  connect_bd_net -net AC_GPIO3_0_1 [get_bd_ports AC_GPIO3_0] [get_bd_pins audio_testbench_0/AC_GPIO3]
  connect_bd_net -net LSFR_0_Q [get_bd_pins LSFR_0/Q] [get_bd_pins axi_gpio_2/gpio_io_i]
  connect_bd_net -net Net [get_bd_ports AC_SDA_0] [get_bd_pins audio_testbench_0/AC_SDA]
  connect_bd_net -net SW_0_1 [get_bd_ports SW_0] [get_bd_pins audio_testbench_0/SW]
  connect_bd_net -net audio_testbench_0_AC_ADR0 [get_bd_ports AC_ADR0_0] [get_bd_pins audio_testbench_0/AC_ADR0]
  connect_bd_net -net audio_testbench_0_AC_ADR1 [get_bd_ports AC_ADR1_0] [get_bd_pins audio_testbench_0/AC_ADR1]
  connect_bd_net -net audio_testbench_0_AC_GPIO0 [get_bd_ports AC_GPIO0_0] [get_bd_pins audio_testbench_0/AC_GPIO0]
  connect_bd_net -net audio_testbench_0_AC_MCLK [get_bd_ports AC_MCLK_0] [get_bd_pins audio_testbench_0/AC_MCLK]
  connect_bd_net -net audio_testbench_0_AC_SCK [get_bd_ports AC_SCK_0] [get_bd_pins audio_testbench_0/AC_SCK]
  connect_bd_net -net audio_testbench_0_LD [get_bd_ports LD_0] [get_bd_pins audio_testbench_0/LD]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins audio_testbench_0/gpio] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins LSFR_0/en] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_vdma_0_mm2s_introut [get_bd_pins axi_vdma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net clk_100_0_1 [get_bd_ports clk_100_0] [get_bd_pins audio_testbench_0/clk_100]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins LSFR_0/reset] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
