...
#
# Generated by export_simulation on Tue Mar 06 09:54:46 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './dma_design_1.sh' script.

./dma_design_1.sh -reset_run
...
./dma_design_1.sh -noclean_files

For more information on the script, please type './dma_design_1.sh -help'.
